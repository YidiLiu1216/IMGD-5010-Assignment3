...
## The original code
![https://editor.p5js.org/YidiLiu1216/sketches/Q4T88_eBX]P5.js Code
...
I make texts randomly scrambled on the image at first. I want them to become lighter and bigger when other texts are close to them, and the raindrops will push the letters away from them. By doing this, viewers will hear the sound in the image. I am just putting it with rain sound now. I hope to connect the raindrop size and frequency with real music after I learn how to analyze music frequency and volume live.
